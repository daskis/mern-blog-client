        ...
        <>
            {isAuth
                ...
                <form onSubmit={event => event.preventDefault()}
                    ...
                    <h1 className="text-2xl text-gray-100 text-center">Вход</h1>
                    ...
                    <div className="flex flex-col gap-4 justify-center">
                        <button
                            ...
                            className="flex justify-center items-center text-lg dark:hover:bg-gray-600 transition-all text-white bg-gray-700 rounded-lg py-4 ">Войти</button>
                        <Link
